    ...
    return (
        ...
        <div key={index}>
            ...
            <div className="product-card" key={plantIndex}>
                ...
                <button  className={`product-button ${IsAlreadyAddedToCart(plant) ? 'added-to-cart' : ''} `} disabled={IsAlreadyAddedToCart(plant)} onClick={() => handleAddToCart(plant)}>Add to cart</button>
            </div>
            ))}
        </div>
    </div>
